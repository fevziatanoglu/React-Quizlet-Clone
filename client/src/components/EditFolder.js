    ...
    return <div className="mt-20 lg:p-16 xs:p-5">
        ...
        <div className="flex flex-col gap-5 mt-10">
            ...
            <button
                ...
                className="bg-blue-800 rounded  text-white text-3xl font-bold flex item-center justify-center p-10 gap-2 hover:bg-yellow-500 hover:text-blue-700">
            ...
            {cards.map((card) => {
                return <>
                    <CardEditItem key={card._id} card={card} removeCardFromList={removeCardFromList} />
        ...
        {/* ADD CARD MODAL */}
        <Modal isOpen={isShowAddCard} onClose={() => setIsShowAddCard(false)} title={"Let's Add a Card"}><AddCard folderId={folderId} /></Modal>
